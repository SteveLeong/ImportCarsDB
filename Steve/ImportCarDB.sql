...
INSERT INTO `car` (`model`, `price`, `transmission`,`engine`, `year`, `manufacturer`, `ethnicity`, `bodytype`, `stock`, `image`, `descrip`) VALUES
...
INSERT INTO `user`(`username`, `name`, `age`, `sex`, `email`, `address`, `password`) VALUES 
					('user1', 'user', 22, 'M', 'email@email', '123 university dr', '123');
